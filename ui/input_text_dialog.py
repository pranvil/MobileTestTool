...
class InputTextDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # 标题
        title_label = QLabel("输入文本到Android设备")
        ...
        self.text_input.setPlaceholderText("在此输入要发送到设备的文本...")
    ...
    def _on_send(self):
        ...
        if not text_to_send:
            QMessageBox.warning(self, "输入错误", "请输入要发送的文本")
            return
        ...
        if success:
            ...
            QMessageBox.critical(self, "失败", "文本发送失败，请检查设备连接")
